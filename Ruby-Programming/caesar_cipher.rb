...
puts "Please, type whatever you want:"
string = gets.chomp

puts "Please, type the shift factor:"
shift_factor = gets.chomp

puts "Please, type the shift direction whether it" +
" is right or left"
shift_direction = gets.chomp

get_caesar_cipher(string, shift_factor, shift_direction)